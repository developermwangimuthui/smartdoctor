        ...
        <div id="userpic" class="userpic">
            ...
            <div class="btn btn-success js-fileapi-wrapper">
                <div class="js-browse">
                    ...
                    <input type="file" name="filedata" accept=".png, .jpg, .jpeg,.zip,.mp4" value="{{ isset($doctor->image) ? $doctor->image : old('image')}}"/>
    ...
    <div class="avatar-upload">
        <div class="avatar-preview">
            <img id="image" class="avatar-preview"
                src="{{ isset($doctor->image) ? Storage::url($doctor->image) : asset('upload.png')}}" alt="image" />
        </div>
    </div>
